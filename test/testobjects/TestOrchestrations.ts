...
export class TestOrchestrations {
    public static NotGenerator: any = df.createOrchestrator(function* () {
        return "Hello";
    });

    public static AnyAOrB: any = df.createOrchestrator(function* (context: any) {
    ...
    public static AnyAOrBYieldATwice: any = df.createOrchestrator(function* (context: any) {
        const completeInOrder = context.df.getInput();
    ...
    public static TimerActivityRace: any = df.createOrchestrator(function* (context: any) {
        const tasks = [];
    ...
    public static AnyWithTaskSet: any = df.createOrchestrator(function* (context: any) {
        const now = new Date(context.df.currentUtcDateTime).getTime();
    ...
    public static CallActivityNoInput: any = df.createOrchestrator(function* (context: any) {
        const returnValue = yield context.df.callActivity("ReturnsFour");
        return returnValue;
    });

    public static CallEntitySet: any = df.createOrchestrator(function* (context: any) {
    ...
    public static CheckForLocksNone: any = df.createOrchestrator(function* (context: any) {
        return context.df.isLocked();
    });

    public static ContinueAsNewCounter: any = df.createOrchestrator(function* (context: any) {
    ...
    public static FanOutFanInDiskUsage: any = df.createOrchestrator(function* (context: any) {
    ...
    public static GetAndReleaseLock: any = df.createOrchestrator(function* (context: any) {
    ...
    public static GetLockBadly: any = df.createOrchestrator(function* (context: any) {
    ...
    public static GuidGenerator: any = df.createOrchestrator(function* (context: any) {
    ...
    public static PassThrough: any = df.createOrchestrator(function* (context: any) {
        const input = context.df.getInput();
        return input;
    });

    public static SayHelloInline: any = df.createOrchestrator(function* (context: any) {
        const input = context.df.getInput();
        return `Hello, ${input}!`;
    });

    public static SayHelloInlineInproperYield: any = df.createOrchestrator(function* (
        context: any
    ) {
    ...
    public static SayHelloWithActivity: any = df.createOrchestrator(function* (context: any) {
        const input = context.df.getInput();
        const output = yield context.df.callActivity("Hello", input);
        return output;
    });

    public static SayHelloWithActivityYieldTwice: any = df.createOrchestrator(function* (
        context: any
    ) {
        const input = context.df.getInput();
    ...
    public static SayHelloWithActivityDirectReturn: any = df.createOrchestrator(function* (
        context: any
    ) {
        const input = context.df.getInput();
    ...
    public static SayHelloWithActivityRetry: any = df.createOrchestrator(function* (context: any) {
        const input = context.df.getInput();
    ...
    public static SayHelloWithActivityRetryAndReturnTimestamps: any = df.createOrchestrator(
    ...
    public static SayHelloWithActivityRetryFanout: any = df.createOrchestrator(function* (
        context: any
    ) {
        const tasks = [];
    ...
    public static SayHelloWithActivityRetryNoOptions: any = df.createOrchestrator(function* (
        context: any
    ) {
    ...
    public static SayHelloWithCustomStatus: any = df.createOrchestrator(function* (context: any) {
        const output = [];
    ...
    public static SayHelloWithSubOrchestrator: any = df.createOrchestrator(function* (
        context: any
    ) {
        const input = context.df.getInput();
    ...
    public static SayHelloWithSubOrchestratorNoSubId: any = df.createOrchestrator(function* (
        context: any
    ) {
        const input = context.df.getInput();
    ...
    public static MultipleSubOrchestratorNoSubId: any = df.createOrchestrator(function* (
        context: any
    ) {
        const input = context.df.getInput();
    ...
    public static SayHelloWithSubOrchestratorRetry: any = df.createOrchestrator(function* (
        context: any
    ) {
        const input = context.df.getInput();
        const childId = context.df.instanceId + ":0";
    ...
    public static SayHelloWithSubOrchestratorRetryFanout: any = df.createOrchestrator(function* (
        context: any
    ) {
        const retryOptions = new df.RetryOptions(100, 5);
        const output = [];
    ...
    public static SayHelloWithSubOrchestratorRetryNoOptions: any = df.createOrchestrator(function* (
        context: any
    ) {
        const childId = context.df.instanceId + ":0";
        const output = yield context.df.callSubOrchestratorWithRetry(
    ...
    public static SayHelloSequence: any = df.createOrchestrator(function* (context: any) {
        const output = [];
    ...
    public static SendHttpRequest: any = df.createOrchestrator(function* (context) {
     ...
     */
    public static TimestampExhaustion: any = df.createOrchestrator(function* (context: any) {
    ...
    public static WaitForExternalEvent: any = df.createOrchestrator(function* (context: any) {
    ...
    public static WaitOnTimer: any = df.createOrchestrator(function* (context: any) {
    ...
    public static ThrowsExceptionFromActivity = df.createOrchestrator(function* (context) {
        yield context.df.callActivity("ThrowsErrorActivity");
    });

    public static ThrowsExceptionFromActivityWithCatch = df.createOrchestrator(function* (context) {
        try {
            yield context.df.callActivity("ThrowsErrorActivity");
        } catch (e) {
            const input = context.df.getInput();
    ...
    public static ThrowsExceptionInline: any = df.createOrchestrator(function* () {
