 ...
 */
export class DurableOrchestrationContext implements DurableOrchestrationContextType {
    constructor(
        state: HistoryEvent[],
        instanceId: string,
    ...
    public newGuid(input: string): string {
        const guidNameValue = `${input}_${this.currentUtcDateTime.valueOf()}_${
            this.newGuidCounter
        }`;
        this.newGuidCounter++;
